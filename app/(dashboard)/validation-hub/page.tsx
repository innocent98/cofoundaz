...
export default function ValidationHub() {
  ...
  return (
    <div className="relative flex min-h-screen w-full min-w-0 flex-col bg-[#f5f7f5] text-[#2c3531] font-sans lg:pl-64">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col">
        ...
        <header className="sticky top-0 z-30 bg-[#f5f7f5]/95 backdrop-blur-sm border-b border-gray-200/70 shadow-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              <button
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-700 shadow-2xs transition-colors hover:bg-gray-50 lg:hidden"
              >
        ...
        {/* MAIN CONTENT AREA */}
        <main className="max-w-7xl mx-auto w-full flex-1 space-y-6 px-4 pt-6 sm:px-6">
          {/* ==================== OVERVIEW TAB ==================== */}
          {activeTab === "Overview" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 flex flex-col justify-between shadow-xs">
                  <span className="text-3xl sm:text-4xl font-serif font-bold text-[#1e4836]">
                    3
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">Validated</span>
                </div>
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 flex flex-col justify-between shadow-xs">
                  <span className="text-3xl sm:text-4xl font-serif font-bold text-[#9d362b]">
                    1
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">Invalidated</span>
                </div>
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 flex flex-col justify-between shadow-xs">
                  <span className="text-3xl sm:text-4xl font-serif font-bold text-[#a47127]">
                    2
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">Untested</span>
                </div>
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 flex flex-col justify-between shadow-xs">
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-100 flex flex-col justify-between shadow-xs col-span-2 sm:col-span-1">
                  <span className="text-3xl sm:text-4xl font-serif font-bold text-[#2d3732]">
                    284
                  </span>
                  <span className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">
              ...
              <div className="bg-[#0e271f] text-white rounded-2xl p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
                ...
                <button
                  ...
                  className="bg-[#b89d5f] hover:bg-[#a68c4f] text-[#1c180e] font-semibold px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl text-xs sm:text-sm transition-all shrink-0 self-start md:self-auto cursor-pointer"
                >
                  Design experiment
                </button>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="bg-[#b89d5f] hover:bg-[#a68c4f] text-[#1c180e] font-semibold px-4 py-2.5 rounded-xl text-xs sm:text-sm transition-all flex items-center gap-2 cursor-pointer shadow-xs disabled:opacity-75"
                >
              ...
              {mvpViewState === "initial" && (
                <div className="space-y-4">
                  {rawFeedbackList.map((item) => (
                    <div
                      key={item.id}
                      className="bg-white rounded-2xl p-5 sm:p-6 border border-gray-200/80 space-y-3 shadow-2xs"
                    >
              ...
              {mvpViewState === "loading" && (
                <div className="bg-white rounded-2xl p-16 border border-gray-200/80 flex flex-col items-center justify-center text-center space-y-6 shadow-2xs my-8 animate-fadeIn">
                  <div className="w-12 h-12 rounded-full border-4 border-gray-200 border-t-[#b89d5f] animate-spin"></div>
                  <p className="text-gray-700 font-serif text-lg italic">
              ...
              {mvpViewState === "synthesized" && (
                <div className="space-y-4 animate-fadeIn">
                  {synthesizedInsights.map((insight) => (
                    <div
                      key={insight.id}
                      className="bg-white rounded-2xl p-5 sm:p-6 border border-gray-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs"
                    >
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-10 h-10 rounded-xl ${insight.iconBg} text-[#1e4836] font-bold flex items-center justify-center shrink-0 mt-0.5 sm:mt-0`}
                        >
                          {insight.iconText}
                        </div>
                      ...
                      <button
                        ...
                        className="bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 font-semibold px-4 py-2 rounded-xl text-xs transition-all cursor-pointer shadow-2xs shrink-0 self-start sm:self-auto"
                      >
                        Send to roadmap
                      </button>
                    </div>
          ...
          {activeTab === "Surveys" && (
            <div className="space-y-6">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold border transition-all cursor-pointer ${
                    isCollectingSurveys
                      ...
                      : "bg-[#1e4836] border-[#1e4836] text-white shadow-xs"
                  }`}
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                <div className="lg:col-span-5 bg-white rounded-2xl p-6 border border-gray-200/80 space-y-6 shadow-2xs">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      <h3 className="font-bold text-gray-900 text-base">Pricing survey</h3>
                      <span
                  ...
                  <div className="bg-[#f5f7f5] rounded-xl p-4 border border-gray-200/60 flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 font-medium px-3 py-2 rounded-lg text-xs transition-all shrink-0 cursor-pointer shadow-2xs"
                    >
                      {surveyLinkCopied ? "Copied!" : "Copy link"}
                    </button>
                  </div>

                  <div className="bg-[#0e271f] rounded-xl p-5 flex items-center justify-between text-white">
                    <div className="space-y-1">
                      <span className="text-xs text-gray-300">Target Segment</span>
                      <p className="text-sm font-semibold">Active Gig Workers</p>
                    </div>
                    <div className="w-12 h-12 bg-[#1b3a30] rounded-lg p-2 grid grid-cols-2 gap-1.5 border border-[#2b5446]">
                      <div className="bg-white/90 rounded-xs"></div>
                      <div className="bg-white/90 rounded-xs"></div>
                      <div className="bg-white/90 rounded-xs"></div>
                      <div className="bg-[#b89d5f] rounded-xs"></div>
                    </div>
                  </div>
                </div>

                <div className="lg:col-span-7 bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 space-y-6 shadow-2xs">
                  <div>
                    <h3 className="font-bold text-gray-900 text-base">Would you pay ₦500/mo?</h3>
                  </div>

                  <div className="space-y-5 text-sm">
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-xs sm:text-sm font-medium">
                        <span className="text-gray-800">Definitely</span>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between text-xs sm:text-sm font-medium">
                        <span className="text-gray-800">Maybe</span>
                        <span className="font-bold text-gray-900">38%</span>
                      </div>
                      <div className="w-full bg-gray-100 rounded-full h-3.5 overflow-hidden p-0.5 border border-gray-200/50">
                        <div
                          className="bg-[#b89d5f] h-full rounded-full transition-all duration-1000"
                          style={{ width: "38%" }}
                        ></div>
                      </div>
                    </div>
          ...
          {activeTab === "Interviews" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                <div className="lg:col-span-5 bg-white rounded-2xl p-6 border border-gray-200/80 space-y-4 shadow-2xs">
                  <div>
                    <h3 className="font-bold text-gray-900 text-sm">New note</h3>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-[#1e4836]"
                      />
                    </div>
                    ...
                    <div>
                      <textarea
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-[#1e4836] resize-none"
                      />
                    </div>
                      ...
                      <button
                        ...
                        className={`py-2 px-3 rounded-xl text-xs font-semibold transition-all border cursor-pointer ${
                          selectedStance === "Supports"
                            ? "bg-white text-emerald-800 border-emerald-800 shadow-2xs"
                      ...
                      <button
                        ...
                        className={`py-2 px-3 rounded-xl text-xs font-semibold transition-all border cursor-pointer ${
                          selectedStance === "Contradicts"
                            ? "bg-white text-red-800 border-red-800 shadow-2xs"
                            : "bg-white text-gray-600 border-gray-200 hover:bg-gray-50"
                        }`}
                      >
                        Contradicts
                      ...
                      <button
                        ...
                        className={`py-2 px-3 rounded-xl text-xs font-semibold transition-all border cursor-pointer ${
                          selectedStance === "Neutral"
                            ? "bg-white text-gray-900 border-gray-900 shadow-2xs"
                            : "bg-white text-gray-600 border-gray-200 hover:bg-gray-50"
                        }`}
                      >
                        Neutral
                    ...
                    <button
                      ...
                      className="w-full bg-[#b89d5f] hover:bg-[#a68c4f] text-[#1c180e] font-semibold py-3 rounded-xl text-sm transition-all cursor-pointer shadow-xs mt-2"
                    >
                      Save note
                    </button>
                  </div>
                ...
                <div className="lg:col-span-7 space-y-4">
                  {interviewsList.map((item) => (
                    <div
                      key={item.id}
                      className="bg-white rounded-2xl p-5 border border-gray-200/80 space-y-3 shadow-2xs hover:border-gray-300 transition-all"
                    >
                      <div className="flex items-center justify-between">
          ...
          {activeTab === "Interview scripts" && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 space-y-6 shadow-2xs max-w-4xl relative">
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    <div className="relative flex-1">
                      <div
                        ...
                        className="w-full bg-white border border-[#b89d5f] rounded-xl px-4 py-3 text-sm text-gray-900 flex items-center justify-between cursor-pointer shadow-xs"
                      >
                      ...
                      {isScriptDropdownOpen && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-30 overflow-hidden divide-y divide-gray-100">
                    ...
                    <button
                      ...
                      className="bg-[#b89d5f] hover:bg-[#a68c4f] text-[#1c180e] font-semibold px-5 py-3 rounded-xl text-sm transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs whitespace-nowrap"
                    >
              ...
              {isScriptGenerated && (
                <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 space-y-6 shadow-2xs max-w-4xl animate-fadeIn">
                  <div>
                    <h3 className="text-lg font-serif font-bold text-gray-900">Draft script</h3>
                  </div>
                  ...
                  <div className="space-y-5 text-sm">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-[#b89d5f] font-medium">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-start">
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200/80 space-y-4 shadow-2xs">
                  ...
                  <div className="space-y-3">
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-[11px] text-gray-400">0 evidence</span>
                      </div>
                    </div>
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      <p className="text-xs sm:text-sm font-medium text-gray-800">
                  ...
                  <div className="space-y-3">
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-[11px] text-gray-500 font-medium">2 evidence</span>
                      </div>
                    </div>
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      <p className="text-xs sm:text-sm font-medium text-gray-800">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-[11px] text-gray-500 font-medium">1 evidence</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200/80 space-y-4 shadow-2xs">
                  <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 className="font-bold text-emerald-800 text-xs sm:text-sm tracking-wide">
                      Validated
                    </h3>
                    <span className="w-6 h-6 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold flex items-center justify-center">
                      1
                  ...
                  <div className="space-y-3">
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-[11px] text-gray-500 font-medium">6 evidence</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200/80 space-y-4 shadow-2xs">
                  <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 className="font-bold text-red-800 text-xs sm:text-sm tracking-wide">
                      Invalidated
                    </h3>
                    <span className="w-6 h-6 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold flex items-center justify-center">
                      1
                  ...
                  <div className="space-y-3">
                    <div className="bg-[#f9faf8] rounded-xl p-3.5 border border-gray-100 space-y-3 shadow-xs">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-[11px] text-gray-500 font-medium">3 evidence</span>
                      </div>
                    </div>
                  </div>
                </div>
