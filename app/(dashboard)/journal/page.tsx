...
export default function JournalPage(): React.JSX.Element {
  ...
  if (isLocked) {
    return (
      <div className="min-h-screen bg-[#0E231B] text-white font-sans antialiased flex flex-col justify-between selection:bg-[#B39353]">
        <header className="border-b border-[#1A382C] px-6 py-3.5 flex items-center justify-between bg-[#0E231B] w-full">
          <div className="flex items-center space-x-3">
            <button 
              onClick={openSidebar}
              className="md:hidden w-9 h-9 rounded-xl border border-[#1E4233] bg-[#122B21] text-white hover:bg-[#1A382C] flex items-center justify-center transition-colors shrink-0 shadow-xs"
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 max-w-md mx-auto text-center space-y-6">
          <div className="w-14 h-14 rounded-2xl bg-[#163326] border border-[#234F3A] flex items-center justify-center text-amber-400 shadow-lg">
            <Lock size={24} />
          </div>

          <div className="space-y-2">
            <h1 className="text-3xl font-serif font-normal tracking-tight text-white">This one is only yours.</h1>
          ...
          <form onSubmit={handleUnlock} className="w-full space-y-3 pt-2">
            <input 
              ...
              className="w-full bg-[#122B21] border border-[#1E4233] rounded-xl px-4 py-3 text-center text-sm text-white placeholder-[#556F60] focus:outline-none focus:border-[#B39353] transition-colors"
            />
            <button
              type="submit"
              className="w-full bg-[#B39353] hover:bg-[#A38346] text-white font-medium py-3 rounded-xl text-xs tracking-wide uppercase transition-colors shadow-md cursor-pointer"
            >
              Unlock journal
            </button>
          </form>
    ...
    <div className="min-h-screen bg-[#FBFBFA] text-[#1E2923] font-sans antialiased relative selection:bg-[#EAD5C6]">
      ...
      <header className="sticky top-0 z-40 border-b border-[#E8E8E2] px-6 py-3.5 flex items-center justify-between bg-white w-full">
        ...
        <div className="flex items-center space-x-3">
          <button 
            ...
            className="border border-[#E0E0DA] bg-white hover:bg-gray-50 text-[#1E2923] px-3.5 py-1.5 rounded-xl text-xs font-semibold flex items-center space-x-1.5 shadow-2xs transition-colors h-[36px] cursor-pointer"
          >
          ...
          <button 
            ...
            className="relative w-9 h-9 rounded-full border border-[#E0E0DA] bg-white flex items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors shadow-xs shrink-0"
          >
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        ...
        {subTab === 'Today' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#EFEFEE] pb-4">
              <div>
                <h1 className="text-3xl font-serif text-[#1C2621] tracking-tight">Saturday, September 5</h1>
                <p className="text-xs text-[#8E9B90] mt-0.5">Nobody reads this but you.</p>
              </div>
              <div className="bg-[#FAF3EC] text-[#9E7C3E] border border-[#F2E5D5] px-3.5 py-1.5 rounded-xl text-xs font-semibold flex items-center space-x-1.5 w-fit">
                <span>🔥</span>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`border rounded-xl py-3.5 px-2 flex flex-col items-center justify-center space-y-2 transition-all cursor-pointer ${
                        isSelected 
                          ? 'border-[#183B28] bg-[#EAF2ED] shadow-xs' 
                          : 'border-[#E8E8E2] hover:bg-gray-50 bg-[#FCFCFB]'
                      }`}
                    >
            ...
            <div className="bg-[#F4EFE6] border border-[#EBE3D3] rounded-2xl p-4 flex items-center justify-between text-xs">
              <div className="flex items-center space-x-3 text-[#5A4D35]">
                <span className="p-2 bg-[#E2D4BC] rounded-lg">✏️</span>
            ...
            <div className="bg-white border border-[#E8E8E2] rounded-2xl shadow-xs p-6 space-y-4">
              <textarea
                value={journalText}
              ...
              <div className="border-t border-[#F2F2EC] pt-4 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="flex items-center space-x-2.5 w-full sm:w-auto justify-end">
                  <button
                    ...
                    className="px-4 py-2 rounded-xl text-xs font-semibold border border-[#E0E0DA] bg-white text-[#1E2923] hover:bg-gray-50 transition-colors cursor-pointer"
                  >
                    Discard
                  </button>
                  <button
                    onClick={handleSaveEntry}
                    className="px-5 py-2 rounded-xl text-xs font-semibold bg-[#B39353] hover:bg-[#A38346] text-white transition-colors shadow-xs cursor-pointer"
                  >
                    Save entry
                  </button>
                </div>
        ...
        {subTab === 'All entries' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <h1 className="text-3xl font-serif text-[#1C2621] tracking-tight">All entries</h1>
              <div className="relative w-full sm:w-72">
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#E8E8E2] rounded-xl pl-10 pr-4 py-2 text-xs text-[#1E2923] placeholder-[#8E9B90] focus:outline-none focus:border-[#B39353]"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              {entries
                ...
                .map((entry) => {
                  ...
                  return (
                    <div key={entry.id} className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-4 hover:border-[#D1D1CB] transition-all">
                      
                      <div className="flex items-center justify-between border-b border-[#F2F2EC] pb-3">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 rounded-lg bg-[#FAF3EC] flex items-center justify-center text-sm shadow-2xs">
                        ...
                        <button 
                          ...
                          className="w-7 h-7 rounded-lg border border-[#E0E0DA] bg-white hover:bg-gray-50 text-gray-600 flex items-center justify-center font-bold text-sm cursor-pointer transition-colors"
                      ...
                      {entry.tags && entry.tags.length > 0 && (
                        <div className="flex items-center space-x-2 pt-1">
                          {entry.tags.map((tag, i) => (
                            <span key={i} className="bg-[#EAF2ED] text-[#183B28] px-2.5 py-0.5 rounded-md text-[10px] font-semibold">
                              {tag}
                            </span>
                          ))}
                        </div>
        ...
        {subTab === 'Mood' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div>
              <h1 className="text-3xl font-serif text-[#1C2621] tracking-tight">Mood over time</h1>
              <p className="text-xs text-[#8E9B90] mt-0.5">The founder journey has a shape. Seeing it helps.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-5 shadow-xs space-y-1">
                <span className="text-[10px] font-bold tracking-wider text-[#8E9B90] uppercase">Entries this month</span>
                <div className="text-3xl font-serif text-[#1C2621] pt-1">12</div>
              ...
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-5 shadow-xs space-y-1">
                ...
                <div className="text-3xl font-serif text-[#1C2621] pt-1">Steady</div>
              ...
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-5 shadow-xs space-y-1">
                ...
                <div className="text-3xl font-serif text-[#1C2621] pt-1">9 days</div>
            ...
            <div className="bg-[#12231B] border border-[#1A382C] rounded-2xl p-5 flex items-start space-x-4 shadow-md text-white">
              <div className="w-8 h-8 rounded-xl bg-[#1B382C] border border-[#234D3A] flex items-center justify-center text-amber-400 shrink-0 mt-0.5">
                ✦
              </div>
        ...
        {subTab === 'Reflections' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <h1 className="text-3xl font-serif text-[#1C2621] tracking-tight">Reflections</h1>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-3 hover:border-[#D1D1CB] transition-all">
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-md bg-[#FAF3EC] flex items-center justify-center text-xs">⌛</span>
                  <span className="text-[10px] font-bold tracking-wider text-[#9E7C3E] uppercase">Recurring theme</span>
                </div>
                <div className="space-y-1.5">
                  <h3 className="font-serif text-lg text-[#1C2621]">You write about money more than anything else</h3>
              ...
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-3 hover:border-[#D1D1CB] transition-all">
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-md bg-[#EAF2ED] flex items-center justify-center text-xs">↗</span>
                  <span className="text-[10px] font-bold tracking-wider text-[#183B28] uppercase">Pattern</span>
                </div>
                <div className="space-y-1.5">
                  <h3 className="font-serif text-lg text-[#1C2621]">Your best days follow customer conversations</h3>
                  <p className="text-xs text-[#617065] leading-relaxed">
              ...
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-3 hover:border-[#D1D1CB] transition-all">
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 rounded-md bg-[#EAF2ED] flex items-center justify-center text-xs">✍️</span>
                  <span className="text-[10px] font-bold tracking-wider text-[#183B28] uppercase">Something you said</span>
                </div>
                <div className="space-y-2">
                  <h3 className="font-serif text-lg text-[#1C2621] italic">“Somewhere safe”</h3>
                  <p className="text-xs text-[#617065] leading-relaxed">
              ...
              <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-3 hover:border-[#D1D1CB] transition-all">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-serif text-lg text-[#1C2621]">Avoidance shows up before hard decisions</h3>
                  <p className="text-xs text-[#617065] leading-relaxed">
        ...
        {subTab === 'Privacy' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div>
              <h1 className="text-3xl font-serif text-[#1C2621] tracking-tight">Journal privacy</h1>
            ...
            <div className="bg-white border border-[#E8E8E2] rounded-2xl p-6 shadow-xs space-y-6">
              ...
              <div className="flex items-center justify-between pb-5 border-b border-[#F2F2EC]">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer shrink-0 ${
                    aiReflectionsEnabled ? 'bg-[#183B28]' : 'bg-gray-300'
                  }`}
              ...
              <div className="flex items-center justify-between pb-5 border-b border-[#F2F2EC]">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer shrink-0 ${
                    biometricsEnabled ? 'bg-[#183B28]' : 'bg-gray-300'
                  }`}
              ...
              <div className="flex items-center justify-between pb-5 border-b border-[#F2F2EC]">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer shrink-0 ${
                    encryptedBackupsEnabled ? 'bg-[#183B28]' : 'bg-gray-300'
                  }`}
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer shrink-0 ${
                    eveningReminderEnabled ? 'bg-[#183B28]' : 'bg-gray-300'
                  }`}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
              <button
                ...
                className="w-full sm:w-1/2 bg-white border border-[#D5D5CF] hover:bg-gray-50 text-[#1E2923] font-medium py-3 rounded-xl text-xs tracking-wide transition-colors shadow-2xs cursor-pointer flex items-center justify-center"
              >
                Export all entries
              </button>
              ...
              <button
                ...
                className="w-full sm:w-1/2 bg-white border border-[#D97762]/60 hover:bg-[#FDF8F7] text-[#C2410C] font-medium py-3 rounded-xl text-xs tracking-wide transition-colors shadow-2xs cursor-pointer flex items-center justify-center"
              >
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs px-4 animate-in fade-in duration-200">
          <div className="bg-white border border-[#E8E8E2] rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl space-y-6 relative">
            
            <div className="space-y-2">
              <h2 className="text-2xl font-serif text-[#991B1B] tracking-tight">Delete your journal permanently?</h2>
              <p className="text-xs text-[#617065] leading-relaxed">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="DELETE"
                className="w-full bg-white border border-[#D5D5CF] rounded-xl px-4 py-2.5 text-xs text-[#1E2923] placeholder-[#A0A8A2] focus:outline-none focus:border-[#991B1B]"
                autoFocus
              />
            </div>
            ...
            <div className="flex items-center space-x-3 pt-2">
              <button
                ...
                className="w-1/2 bg-white border border-[#D5D5CF] hover:bg-gray-50 text-[#1E2923] font-medium py-3 rounded-xl text-xs tracking-wide transition-colors cursor-pointer"
              >
                Keep my journal
              </button>
              ...
              <button
                ...
                className={`w-1/2 font-medium py-3 rounded-xl text-xs tracking-wide transition-colors ${
                  deleteConfirmText === 'DELETE'
                    ? 'bg-[#991B1B] hover:bg-[#7F1D1D] text-white cursor-pointer shadow-md'
